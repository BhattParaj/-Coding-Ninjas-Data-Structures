...
int main() {
    ...
    float ans =a+(0.2*a)+(0.5*a)+allow-(0.11*a);
    cout<<lround(ans)<<endl;
// lround() Function in C++ The C++ round() function is used to round a double, float, or long double value passed as a parameter to the nearest integer value.
